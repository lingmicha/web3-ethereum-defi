...
LENDING_MARKETS: dict[str, LendingMarket] = {
    ...
    'bsc-wepiggy': LendingMarket(
        ...
        token_contracts={
            ...
            'WBNB': WepiggyToken(
                token_address=Web3.toChecksumAddress('0xA000000000000000000000000000000000000000'),
                deposit_address=Web3.toChecksumAddress('0x33A32f0ad4AA704e28C93eD8Ffa61d50d51622a7'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'ETH': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x2170Ed0880ac9A755fd29B2688956BD959F933F8'),
                deposit_address=Web3.toChecksumAddress('0x849C37A029B38D3826562697Ccc40c34477C6293'),
                model_address=Web3.toChecksumAddress('0xd1121ade04ee215524aefbf7f8d45029214d668d'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.2'),
                                                                kink=Decimal('0.65'),
                                                                base_rate_per_block=Decimal('0'),
            ...
            'BTC': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c'),
                deposit_address=Web3.toChecksumAddress('0x311aEA58Ca127B955890647413846E351df32554'),
                model_address=Web3.toChecksumAddress('0xd1121ade04ee215524aefbf7f8d45029214d668d'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.2'),
                                                                kink=Decimal('0.65'),
                                                                base_rate_per_block=Decimal('0'),
            ...
            'DAI': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3'),
                deposit_address=Web3.toChecksumAddress('0x12D803497D1e58dD4D4A4F455D754f1d0F937C8b'),
                model_address=Web3.toChecksumAddress('0xc1b02e52e9512519edf99671931772e452fb4399'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.1'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('0'),
                                                                multiplier_per_block=Decimal('4.756468797E-9'),
            ...
            'USDT': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x55d398326f99059fF775485246999027B3197955'),
                deposit_address=Web3.toChecksumAddress('0x2a8Cd78bFb91ACF53f589961D213d87c956e0d7f'),
                model_address=Web3.toChecksumAddress('0xc1b02e52e9512519edf99671931772e452fb4399'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.1'),
                                                               kink=Decimal('0.8'),
                                                               base_rate_per_block=Decimal('0'),
            ...
            'USDC': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d'),
                deposit_address=Web3.toChecksumAddress('0x2B7F68170a598E507B19Bca41ED745eABc936B3F'),
                model_address=Web3.toChecksumAddress('0xc1b02e52e9512519edf99671931772e452fb4399'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.1'),
                                                               kink=Decimal('0.8'),
                                                               base_rate_per_block=Decimal('0'),
            ...
            'BUSD': WepiggyToken(
                token_address=Web3.toChecksumAddress('0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56'),
                deposit_address=Web3.toChecksumAddress('0x2dd8FFA7923a17739F70C34759Af7650e44EA3BE'),
                model_address=Web3.toChecksumAddress('0xc1b02e52e9512519edf99671931772e452fb4399'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.1'),
                                                               kink=Decimal('0.8'),
                                                               base_rate_per_block=Decimal('0'),
            ...
            'DOT': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402'),
                deposit_address=Web3.toChecksumAddress('0x811Cd5CB4cC43F44600Cfa5eE3F37a402C82aec2'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'UNI': WepiggyToken(
                token_address=Web3.toChecksumAddress('0xBf5140A22578168FD562DCcF235E5D43A02ce9B1'),
                deposit_address=Web3.toChecksumAddress('0x17933112E9780aBd0F27f2B7d9ddA9E840D43159'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
            ...
            'CAKE': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82'),
                deposit_address=Web3.toChecksumAddress('0x417FDfC74503d8008AeEB53248E5C0f1960c2C1d'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'LTC': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x4338665CBB7B2485A8855A139b75D5e34AB0DB94'),
                deposit_address=Web3.toChecksumAddress('0x6a05BD123d780055c38526cC05d3c9B90D0E471c'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'LINK': WepiggyToken(
                token_address=Web3.toChecksumAddress('0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD'),
                deposit_address=Web3.toChecksumAddress('0x00FF07204C3b27D72cF83Ef521Adb7066167561a'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'ADA': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47'),
                deposit_address=Web3.toChecksumAddress('0xBc52BCE2C73Fec358ABBf047c50377183B9EAd0d'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
            ...
            'FIL': WepiggyToken(
                token_address=Web3.toChecksumAddress('0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153'),
                deposit_address=Web3.toChecksumAddress('0xDF21D42a0fC6746718F2CFe2798F91C9d7277F32'),
                model_address=Web3.toChecksumAddress('0x621ce6596e0b9ccf635316bfe7fdbc80c3029bec'),
                model=JumpInterestModel(InterestModelParameters(reserve_factor=Decimal('0.25'),
                                                                kink=Decimal('0.8'),
                                                                base_rate_per_block=Decimal('1.902587519E-9'),
...
DEPOSIT_ADDRESS_TO_TOKEN_NAME: dict[ChecksumAddress, str] = {}  # autofill later
...
def get_token_name_by_deposit_address(deposit_address: ChecksumAddress) -> Optional[str]:
    ...
    return DEPOSIT_ADDRESS_TO_TOKEN_NAME.get(deposit_address, None)


def _autofill_token_addresses():
    for network in LENDING_MARKETS.values():
        for token_name, token in network.token_contracts.items():
            assert token.deposit_address not in DEPOSIT_ADDRESS_TO_TOKEN_NAME, \
                "出现重复的deposit address:{}".format(token.deposit_address)
            DEPOSIT_ADDRESS_TO_TOKEN_NAME[token.deposit_address] = token_name
